...
public class LinkedWeb extends AppCompatActivity {

/*CONSTANT FOR THE AUTHORIZATION PROCESS*/

    /****YOUR LINKEDIN APP INFO HERE*********/
    private static final String API_KEY = "75l0p2980lnm97";
    private static final String SECRET_KEY = "ac7Z8tWRkZQbSvV7";
    //This is any string we want to use. This will be used for avoid CSRF attacks. You can generate one here: http://strongpasswordgenerator.com/
    private static final String STATE = "Y8@l72486sAZ8Eg";
    private static final String REDIRECT_URI = "http://com.ceefy.redirecturl";
    ...
    private class PostRequestAsyncTask extends AsyncTask<String, Void, Boolean>{
        ...
        protected void onPreExecute(){
            pd = ProgressDialog.show(LinkedWeb.this, "", "Loading..",true);
        }
                    ...
                    if(response!=null){
                        ...
                        if(response.getStatusLine().getStatusCode()==200){
                            ...
                            if(expiresIn>0 && accessToken!=null){
                                ...
                                SharedPreferences preferences = LinkedWeb.this.getSharedPreferences("user_info", 0);
